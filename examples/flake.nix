{
  ...
  outputs = { self, micropython-builder }: {
    packages.x86_64-linux.default = micropython-builder.lib.x86_64-linux.buildMicroPythonFirmware {
      port = "esp32";
    ...
    packages.x86_64-linux.withAIoHttp = micropython-builder.lib.x86_64-linux.buildMicroPythonFirmware {
      port = "esp32";
      board = "ESP32_GENERIC_C3";
    ...
    packages.x86_64-linux.withUserCModules = micropython-builder.lib.x86_64-linux.buildMicroPythonFirmware {
      port = "esp32";
      board = "ESP32_GENERIC_C3";
    ...
    packages.x86_64-linux.withPatchPhase = micropython-builder.lib.x86_64-linux.buildMicroPythonFirmware {
      port = "esp32";
      board = "ESP32_GENERIC_C3";
      patchPhase = ''
    ...
    # `nix run .#flash`
    packages.x86_64-linux.flash = micropython-builder.lib.x86_64-linux.flashMicroPythonFirmware {
      port = "esp32";
      board = "ESP32_GENERIC_C3";
      sha256 = "sha256-pgp40inNjT1cCX2S8/EjVTTytaK7zz8+x1sT7nWLHT0=";
    } { chip = "esp32c3"; };
